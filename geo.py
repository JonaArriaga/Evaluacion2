...
key = "15768f64-81aa-4da5-9e3e-0ddbdccf14f9"      
...
while True:
    ...
    print("Para salir, escriba salir o s")
    vehicle = input("Introduzca alguno de los perfiles de vehículos de la lista anterior (en inglés): ")
    if vehicle == "salir" or vehicle == "s":
        ...
        vehicle = "car"
        print("Se introdujo un perfil de vehículo invalido. Se utilizará car (auto) por defecto.")
    print("Para salir, escriba salir o s")
    ...
    if paths_status == 200:
        ...
        print("Duración del viaje: {:02d}:{:02d}:{:05.2f}".format(hr, min, sec))
        print("=================================================")
